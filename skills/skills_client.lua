...
function createSkillBar ( fullState, parent, x, y, width, height )
	...
	gImage["skillBar"..skillBars] = guiCreateStaticImage ( x, y, width, height, ":"..getResourceName(getThisResource()).."/images/skills/bg.png", false, parent )
	
	guiCreateStaticImage ( side, 0, barSize, height, ":"..getResourceName(getThisResource()).."/images/skills/px.png", false, gImage["skillBar"..skillBars] )
	guiCreateStaticImage ( barSize + side, 0, 77 / width * 6, height, ":"..getResourceName(getThisResource()).."/images/skills/cur.png", false, gImage["skillBar"..skillBars] )
	guiCreateStaticImage ( 0, 0, width, height, ":"..getResourceName(getThisResource()).."/images/skills/bar.png", false, gImage["skillBar"..skillBars] )
...
function showSkillInfo_func ( text, fullState, left, cur )
	...
	gImage["skillBG"] = guiCreateStaticImage( 3 * 2 + 235,3,102,79,":"..getResourceName(getThisResource()).."/images/colors/c_red.jpg",false)
