...
function DownloadFiles()
	...
	outputDebugString(DEBUG_TAG.."Requesting (" .. UpdateCount .. "/" .. (#preUpdate or "Unknown") .. "): " .. tostring(currentPath) .. "")
	
	local url = "https://raw.githubusercontent.com/"..REPO_USER.."/"..REPO_NAME.."/"..REPO_BRANCH.."/"..currentPath
	...
	fetchRemote(url, function(data, err, path)
		if err == 0 then
			...
			outputDebugString(DEBUG_TAG.."Download Failed: "..path.." (ERROR: "..err.." / "..errorString..")!", 2)
		end
