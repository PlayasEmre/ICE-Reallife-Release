...
function showChipBuy_func ()
	...
	if gWindow["chipBuy"] then
		...
		gLabel[3] = guiCreateLabel(139,67,13,26,""..Tables.waehrung.."",false,gWindow["chipBuy"])
		...
		gImage[1] = guiCreateStaticImage(153,94,50,50,":"..getResourceName(getThisResource()).."/images/inventory/chip.png",false,gWindow["chipBuy"])
