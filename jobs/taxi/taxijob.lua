...
function VehicleTaxiEnter ( player, seat )
	if MtxGetElementData ( player, "job" ) == "taxifahrer" and seat == 0 then
...
function paycheckTaxi ( passenger, driver )
	...
	if getPedOccupiedVehicleSeat ( driver ) == 0 and getPedOccupiedVehicleSeat ( passenger ) then
		if MtxGetElementData ( passenger, "money" ) >= taxipreis then
			MtxSetElementData ( passenger, "money", MtxGetElementData ( passenger, "money" ) - taxipreis )
			MtxSetElementData ( driver, MtxGetElementData ( driver, "money" ) + taxipreis )
			setTimer ( paycheckTaxi, 5000, 1, passenger, driver )
		else
