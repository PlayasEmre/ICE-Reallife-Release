...
function showAirportJobGui_func ()
	...
	if gWindow["airportJob"] then
		...
		gColumn["belohnung"] = guiGridListAddColumn(gGrid["airportChoose"],""..Tables.waehrung.."",0.15)
		...
		guiGridListSetItemText ( gGrid["airportChoose"], row, gColumn["belohnung"], " 75 "..Tables.waehrung.."", false, false )
		local row = guiGridListAddRow ( gGrid["airportChoose"] )
		guiGridListSetItemText ( gGrid["airportChoose"], row, gColumn["job"], "Insektenkiller", false, false )
		guiGridListSetItemText ( gGrid["airportChoose"], row, gColumn["belohnung"], "125 "..Tables.waehrung.."", false, false )
		local row = guiGridListAddRow ( gGrid["airportChoose"] )
		guiGridListSetItemText ( gGrid["airportChoose"], row, gColumn["job"], "Leichter Flug", false, false )
		guiGridListSetItemText ( gGrid["airportChoose"], row, gColumn["belohnung"], "225 "..Tables.waehrung.."", false, false )
		local row = guiGridListAddRow ( gGrid["airportChoose"] )
		guiGridListSetItemText ( gGrid["airportChoose"], row, gColumn["job"], "Mittlerer Flug", false, false )
		guiGridListSetItemText ( gGrid["airportChoose"], row, gColumn["belohnung"], "300 "..Tables.waehrung.."", false, false )
		local row = guiGridListAddRow ( gGrid["airportChoose"] )
		guiGridListSetItemText ( gGrid["airportChoose"], row, gColumn["job"], "Schwerer Flug", false, false )
		guiGridListSetItemText ( gGrid["airportChoose"], row, gColumn["belohnung"], "500 "..Tables.waehrung.."", false, false )
