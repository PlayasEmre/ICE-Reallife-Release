...
function showBaumarktMenue ( hit )
	...
	if hit == lp then
		...
		if gWindow["baumarkt"] then
			...
			gWindow["baumarkt"] = guiCreateStaticImage(screenwidth/2-445/2,screenheight/2-294/2,445,294,":"..getResourceName(getThisResource()).."/images/background.png",false)
			...
			local btn = gButton[1]
			clickedbut = 841
			local img = guiCreateStaticImage(8,6,50,50,":"..getResourceName(getThisResource()).."/images/inventory/placeable/campfire.png",false,btn)
			guiSetAlpha(img,1)
			local label = guiCreateLabel(63,10,65,52,"Lagerfeuer\n\n"..placeablePrices[clickedbut].." "..Tables.waehrung.."",false,btn)
			guiSetAlpha(label,1)
			...
			local btn = gButton[2]
			clickedbut = 3461
			local img = guiCreateStaticImage(8,6,50,50,":"..getResourceName(getThisResource()).."/images/inventory/placeable/torch.png",false,btn)
			guiSetAlpha(img,1)
			...
			local btn = gButton[3]
			clickedbut = 1946
			local img = guiCreateStaticImage(8,6,50,50,":"..getResourceName(getThisResource()).."/images/inventory/placeable/ball_a.png",false,btn)
			guiSetAlpha(img,1)
			...
			local btn = gButton[4]
			clickedbut = 1598
			local img = guiCreateStaticImage(8,6,50,50,":"..getResourceName(getThisResource()).."/images/inventory/placeable/ball_b.png",false,btn)
			guiSetAlpha(img,1)
			...
			local btn = gButton[5]
			clickedbut = 1481
			local img = guiCreateStaticImage(8,6,50,50,":"..getResourceName(getThisResource()).."/images/inventory/placeable/grill.png",false,btn)
			guiSetAlpha(img,1)
			...
			local btn = gButton[6]
			clickedbut = 1255
			local img = guiCreateStaticImage(8,6,50,50,":"..getResourceName(getThisResource()).."/images/inventory/placeable/liege.png",false,btn)
			guiSetAlpha(img,1)
			...
			local btn = gButton[7]
			clickedbut = 1640
			local img = guiCreateStaticImage(8,6,50,50,":"..getResourceName(getThisResource()).."/images/inventory/placeable/towel.png",false,btn)
			guiSetAlpha(img,1)
