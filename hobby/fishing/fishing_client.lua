...
function startFishing ()
	...
	fishingImage = guiCreateStaticImage ( screenwidth/2-100/2, 0, 100, 100, ":"..getResourceName(getThisResource()).."/images/skills/fishing/top.png", false )
	...
	fishingTimer = setTimer (
		function ()
			...
			fishingImage = guiCreateStaticImage ( screenwidth/2-100/2, 0, 100, 100, ":"..getResourceName(getThisResource()).."/images/skills/fishing/down.png", false )
			fishingTimer = setTimer (
				function ()
					destroyElement ( fishingImage )
...
function fishingShop_hit ( player, dim )
	...
	if player == lp and dim and not getPedOccupiedVehicle ( player ) then
		...
		guiLabelSetHorizontalAlign(gLabel[2],"left",false)
		guiSetFont(gLabel[2],"default-bold-small")
		gImage[1] = guiCreateStaticImage(332,29+57*0,50,50,":"..getResourceName(getThisResource()).."/images/inventory/fishing/pole.png",false,gWindow["fishingShop"])
		...
		gImage[2] = guiCreateStaticImage(332,29+57*1,50,50,":"..getResourceName(getThisResource()).."/images/inventory/fishing/hook.png",false,gWindow["fishingShop"])
		...
		gImage[3] = guiCreateStaticImage(332,29+57*2,50,50,":"..getResourceName(getThisResource()).."/images/inventory/fishing/worm.png",false,gWindow["fishingShop"])
