function hud_trigger_1(player)
	...
	dbExecAsync ( handler, "UPDATE ?? SET ?? = ? WHERE ??=?", "userdata", "hud", "1", "UID", playerUID[player] )
...
function hud_trigger_2(player) 
	...
	dbExecAsync ( handler, "UPDATE ?? SET ?? = ? WHERE ??=?", "userdata", "hud", "2", "UID", playerUID[player] )
...
--[[function hud_trigger_3()
	...
	dbExecAsync ( handler, "UPDATE ?? SET ?? = ? WHERE ??=?", "userdata", "hud", "3", "UID", playerUID[player] )
