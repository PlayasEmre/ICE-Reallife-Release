...
addEventHandler ( "onClientMarkerHit", marker,
	function ( hit, dim )
		if hit == localPlayer and dim and not isPedInVehicle(localPlayer) then
			...
			gLabel["lottoJackpot"] = guiCreateLabel(115+3,24,225-115,100,"Kosten: 100 "..Tables.waehrung..",\nnur 3 Scheine\npro Person,\nakt. Jackpot:\n50.000 "..Tables.waehrung.."",false,gWindow["lotto"])
...
function recieveLottoJackpot ( jackpot )
	if isElement ( gLabel["lottoJackpot"] ) then
		guiSetText ( gLabel["lottoJackpot"], "Kosten: 100 "..Tables.waehrung..",\nnur 3 Scheine\npro Person,\nakt. Jackpot:\n"..formNumberToMoneyString ( jackpot ) )
	end
end
