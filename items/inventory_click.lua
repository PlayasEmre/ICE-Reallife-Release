...
validItems = { ["Zeitung"]=true, ["Kanister"]=true, ["Drogen"]=true, ["Materialien"]=true, ["Wuerfel"]=true, ["Zigaretten"]=true, ["Erste Hilfe"]=true, ["Bier"]=true, ["Burger"]=true, ["Snack"]=true, ["Suessigkeiten"]=true, ["Hanfsamen"]=true, ["Ehre"]=true, ["Luftwaffe"]=true, ["Verdienst"]=true, ["Notebook"]=true,["Chips"]=true, ["Hufeisen"]=true, ["Geschenk"]=true,["Angel"]=true, ["Haken"]=true, ["Koeder"]=true, ["Fernglas"]=true, ["Kuerbis"]=true, ["Phosphor"]=true, ["Dum-Dum"]=true, ["Panzerbrechend"]=true, ["Vulcano"]=true, ["Pfeffer"]=true, ["Halloween-Munition"]=true }
...
function showInventory_func ()
	...
	if not isCursorShowing () and not getElementClicked() and not tutorial and not isPedDead ( lp ) then
		...
		if gWindow["inventory"] then
			...
			gWindow["inventory"] = guiCreateStaticImage(screenwidth/2-380/2,screenheight/2-320/2,400,340,":"..getResourceName(getThisResource()).."/images/gui/inventar.png",false)
...
function newSelection ()
	...
	if selectedText then
		if validItems[selectedText] then
			...
			gImage["itemImage"] = guiCreateStaticImage(0.75,0.2,0.15,0.15,":"..getResourceName(getThisResource()).."/images/inventory/"..itemImage[selectedText],true,gWindow["inventory"])
...
function fillWithItems ( grid, columnName, columnCount )
	...
	guiGridListClear ( grid )
		if vioClientGetElementData ( "easterEggs" ) >= 1 then
		local row = guiGridListAddRow ( grid )
		guiGridListSetItemText ( grid, row, columnName, "Kuerbis", false, false )
		if vioClientGetElementData ("easterEggs" ) == 1 then value = "" else value = vioClientGetElementData ("easterEggs" ) end
