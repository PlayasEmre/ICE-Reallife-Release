	...
	if hit == localPlayer and dim then
		if not getPedOccupiedVehicle ( localPlayer ) then
			...
			if gWindow["wohnwagen"] then
				...
				gLabel[3] = guiCreateLabel(13,114,63,15,"50.500 "..Tables.waehrung.."",false,gWindow["wohnwagen"])
				...
				gImage[1] = guiCreateStaticImage(193,113,95,74,":"..getResourceName(getThisResource()).."/images/gui/trailer.png",false,gWindow["wohnwagen"])
