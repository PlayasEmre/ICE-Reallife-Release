...
function showColorSelection ()
	...
	if veh then
		...
		colorSelectionImage = guiCreateStaticImage ( 1, 20, 400, 140, ":"..getResourceName(getThisResource()).."/images/colors/carcolors.png", false, vehicleColorSelectionWindow )
...
function showCarColorSelection ( x, y )
	...
	x = x * 20
	y = y * 20
	colorSelected = guiCreateStaticImage ( x, y, 20, 20, ":"..getResourceName(getThisResource()).."/images/colors/selection.png", false, colorSelectionImage )
end
