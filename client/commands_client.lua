...
local allFactionCommands = {
	...
	[2] = {
		[0] = { "/mv - Öffnet die Tore/Schranken",
				...
				"/matstruck - Startet einen Matstruck für 5.000"..Tables.waehrung.."",
	...
	[4] = {
		...
		[4] = { "/invite [Name] - Nimmt jemanden in die Fraktion auf",
				...
				"/c4 - mit dem Comand kannst du eine Bombe erstellen",
				"/c4back - mit dem Comand kannst du die Bombe entfernen",
				"/detonatec4 - mit dem Comand kannst du die Bombe zünden",
				"/bombe - Bombe erstellen",
				"/frakpm [Text] - Schickt jedem Mitglied eine Nachricht (auch offline)" }
	},
	[5] = {
		[0] = { "/mv - Öffnet die Tore/Schranken", 
	...
	[8] = {
		...
		[1] = { "/stellen - Aktiviert/Deaktiviert das Stellen",
				...
				"/nuklear Mit dem Befehl kannst du eine Bombe zünden Du brauchst die permissions /class air ",
	...
	[14] = {
		[0] = {"Mit /hackbhf kannst du den ATM am Bahnhof hacken",
			   "Mit /hacknoob kannst du den ATM am Noobspawn hacken",
			   "Mit /hackstadt kannst du den ATM an der Stadthalle hacken",
			   "Mit /hackwangcars kannst du den ATM am wangcars über dem wangcars hacken",
			   "Mit /hackhandy kannst du das Handy eines anderen Spielers hacken und es an oder ausmachen",
			   "Mit /hackwanteds kannst du die Wanteds eines Spielers löschen"
			  }
			}, 
			  
	[15] = {
		[0] = {"Mit /fduty kannst du In den Dienst gehen",
			   "Mit /foffduty kannst du den Dienst verlassen",
			   "Mit /fpruefung [Name] [Schein]  Du kannst einen Spieler eine Fahrstunde anbieten",
			   "Mit /stoppruefung [Name] Du kannst ein Spieler seine Lizenz übergeben",
			  }
	},
}
...
local allAdminCommands = {
	...
	-- [1] Supporter
	[1] = { "/report - Kannst du in die Halle",
			"/getchangestate [Name] - Prüft letzten Invite/Uninvite des Spielers",
			"/o [Text] - Benutzt den öffentlichen Admin-Chat",
			"/akn Mit dem Befehl kannst du Aktionen beenden",
			"/adchat Mit ad chat kannst du den Chat aktivieren und deaktivieren",
	...
	[3] = { "/setnailmax [Anzahl] - Ändert die max. Anzahl der Nagelbänder im Auto",
			...
			"/delhouse -  Haus Marker löschen",
			"/makefft - Lässt ein Auto FFT werden (ohne Motor)",
			"/getinfo [Name] Mit diesem Befehl kannst du Spieler seitiger Informationen erfahren",
			"/kickall [Grund] - Kickt alle Spieler" },
	-- [4] Stellv. Projektleiter
	[4] = { "/shut - Notabschaltung",
			"/give [Name] [amount] Du kannst mit give coin,geld,bankgeld setzen" },
	-- [5] Projektleiter
	[5] = { "/gmx [Minuten] - Restartet den Server",
			"/adminlevel [Name] [Rang] - Gibt jemandem Adminrang",
			"/setPremium [Name] [Tage] [Paket]",
            "/savedata Du kannst mit savedata die Spielerdaten speichern",
			"/setlevel [Name] [level] Du kannst mit setlevel level setzen" },
	-- [6] Entwickler (aktuell keine exklusiven Befehle)
	[6] = {}
}
