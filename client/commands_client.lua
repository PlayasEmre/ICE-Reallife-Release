...
local allAdminCommands = {
	...
	[2] = { "/smode - Geht Adminduty",
			...
			"/entban [Name] - Entbannt einen selbstgebannten Spieler",
	...
	[3] = { "/newhouse [Preis] [Interior] - Erstellt einen Interior",
	...
	[5] = { "/settestgeld [Anzahl] - Settet Testgeld", 
