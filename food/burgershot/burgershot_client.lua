...
function showDriveIn_func ( hit, dim )
	...
	if hit == lp and dim and diff < 5 then
		...
		if gWindow["burgershotDriveIn"] then
			...
			gLabel["burgershotInfo2"] = guiCreateLabel(0.2993,0.5656,0.0915,0.1311, burgerPrice.." "..Tables.waehrung.."",true,gWindow["burgershotDriveIn"])
			...
			gLabel["burgershotPrice1"] = guiCreateLabel(0.7711,0.6066,0.0906,0.1301, snackPrice.." "..Tables.waehrung.."",true,gWindow["burgershotDriveIn"])
