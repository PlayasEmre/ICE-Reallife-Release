...
function showNewspaper_func ( text )
	...
	if gWindow["newspaper"] then
		...
		gImage["newspaper"] = guiCreateStaticImage(18,23,281,73,":"..getResourceName(getThisResource()).."/images/liberty_tree.png",false,gWindow["newspaper"])
...
function showNewspaperReporter_func ( text )
	...
	if gWindow["newspaperEdit"] then
		...
		gImage["newspaperEdit"] = guiCreateStaticImage(18,23,281,73,":"..getResourceName(getThisResource()).."/images/liberty_tree.png",false,gWindow["newspaperEdit"])
