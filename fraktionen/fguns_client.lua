...
function createFgunsGui (therank, thefrac)
	...
	if thefrac == 3 then
		...
		if therank >= 2 then
			...
			GUIEditor.label[7] = guiCreateLabel(0.03, 0.48, 0.25, 0.04, Moneycost[4]..""..Tables.waehrung.."", true, GUIEditor.window[1])
	...
	GUIEditor.label[1] = guiCreateLabel(0.03, 0.22, 0.25, 0.04, Moneycost[1]..""..Tables.waehrung.."", true, GUIEditor.window[1])
	...
	GUIEditor.label[3] = guiCreateLabel(0.39, 0.22, 0.25, 0.04, Moneycost[2]..""..Tables.waehrung.."", true, GUIEditor.window[1])
	...
	if therank >= 1 then
		...
		GUIEditor.label[5] = guiCreateLabel(0.73, 0.22, 0.25, 0.04, Moneycost[3]..""..Tables.waehrung.."", true, GUIEditor.window[1])
	...
	if therank >= 2 then
		...
		GUIEditor.label[9] = guiCreateLabel(0.39, 0.48, 0.24, 0.04, Moneycost[5]..""..Tables.waehrung.."", true, GUIEditor.window[1])
	...
	if therank >= 3 then
		...
		GUIEditor.label[13] = guiCreateLabel(0.03, 0.73, 0.25, 0.04, Moneycost[7]..""..Tables.waehrung.."", true, GUIEditor.window[1])
		...
		GUIEditor.label[11] = guiCreateLabel(0.73, 0.48, 0.25, 0.04, Moneycost[6]..""..Tables.waehrung..""..""..Tables.waehrung.."", true, GUIEditor.window[1])
	...
	if therank >= 4 then
		...
		GUIEditor.label[15] = guiCreateLabel(0.39, 0.73, 0.25, 0.04, Moneycost[8]..""..Tables.waehrung.."", true, GUIEditor.window[1])
	...
	if therank >= 5 then
		...
		GUIEditor.label[17] = guiCreateLabel(0.73, 0.73, 0.25, 0.04, Moneycost[9]..""..Tables.waehrung.."", true, GUIEditor.window[1])
